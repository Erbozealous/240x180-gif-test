...
captionBackground.setPosition(120, 90)
...
animation.runImageAnimation(vignette, getProjectAnim("vignette"), 150, true)
vignette.z = 100
...
function getProjectAnim(anim: string) {
    if (anim == "vignette") {
        return assets.animation`vignette3`
